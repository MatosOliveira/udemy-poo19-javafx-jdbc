...
public class SellerListController implements Initializable, DataChangeListener {
	 ...
	 * 
	 * Stage dialogStage = new Stage(); dialogStage.setTitle("Enter Seller name");
	 ...
	 * 
	 * @Override protected void updateItem(Seller obj, boolean empty) {
	 * super.updateItem(obj, empty); if (obj == null) { setGraphic(null); return; }
